...
User says yes → AI fills out the format from `library/post-mortem-core.md`.
...
3. If yes: fill out format from `library/post-mortem-core.md`, ask clarifying questions as needed
4. Append entry to `session/post-mortems.md`
...
- Check `session/post-mortems.md` for relevant entries
