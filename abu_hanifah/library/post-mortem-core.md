...
## Storage File
All entries are appended to: `session/post-mortems.md`
...
4. Appends to `session/post-mortems.md` after confirmation
...
1. Scan `session/post-mortems.md` for entries matching the current domain
